...
function EventsGridCard({ id, titulo, descripcion, color, bgColor, imagen }: { id: string, titulo: string, descripcion: string, bgColor: string, imagen: string, color: string }){
